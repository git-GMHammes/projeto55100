...
CREATE TABLE `view_municipio_RJ` (
	...
	`md_id` BIGINT NULL,
	`md_candidato_2022_RJ_id` BIGINT NULL,
	`md_candidato_2024_RJ_id` BIGINT NULL,
	`md_cargo_politico` VARCHAR(1) NULL COLLATE 'utf8mb4_unicode_ci',
	`md_suplente_candidato_RJ_id` INT NULL,
	...
	`mn_created_at` DATETIME NOT NULL,
	`mn_updated_at` DATETIME NULL,
