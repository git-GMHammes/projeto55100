...
DROP VIEW IF EXISTS `view_votacao_candidato_munzona_2022_RJ_group`;
...
DROP VIEW IF EXISTS `view_votacao_candidato_munzona_2024_RJ_group`;
...
DROP VIEW IF EXISTS `view_votos_municipio_2022`;
CREATE TABLE `view_votos_municipio_2022` (
...
DROP VIEW IF EXISTS `view_votos_municipio_2024_RJ`;
...
CREATE TABLE IF NOT EXISTS `votacao_candidato_munzona_2022_RJ` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=524281 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Votação por candidato/município/zona com resultado — Eleições 2022 RJ';
